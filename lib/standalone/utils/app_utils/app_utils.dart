...
class AppUtils {
  ...
  //     String path, String contractAddr,
  //     {String? contractName}) async {
  ...
  static String stringDateToDateTime(String stringData) {
    ...
    return formatDate(DateTime.parse(tmp[0]),
        [yyyy, '-', mm, '-', dd]); /* Return Real Date Time */
  }
  ...
  static String dateTimeToDateOnly(DateTime timeStamp) {
    ...
    return formatDate(
        timeStamp, [yyyy, '-', mm, '-', dd]); /* Return Real Date Time */
  }
  ...
  static String dateTimeToTimeOnly(DateTime timeStamp) {
    ...
    return formatDate(
        timeStamp, [hh, ':', nn, ':', ss, ' ', am]); /* Return Real Date Time */
  }
  ...
  //     {bool? isDark, String? hexaColor, Color? enumColor}) {
  //   if (hexaColor != null) {
  ...
  //           const TextSpan(
  //             text:
  //                 '''IMPORTANT DISCLAIMER: All content provided herein our website, hyperlinked sites, associated applications, forums, blogs, social media accounts and other platforms ("Site") is for your general information only, procured from third party sources. ''',
  //           ),
  //           TextSpan(
  //               text: 'Read More',
  //               style: TextStyle(
