...
declare type Versions = 'V3' | 'V2' | 'V1' | 'V0';
declare type Converter = (registry: Registry, vx: any) => ContractMetadataLatest;
export declare function v3ToLatest(registry: Registry, v3: ContractMetadataV3): ContractMetadataLatest;
...
export declare const enumVersions: string[];
