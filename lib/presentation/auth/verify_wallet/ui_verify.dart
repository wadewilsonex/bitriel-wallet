// import 'package:bitriel_wallet/application/utils/app_utils/global.dart';
// import 'package:bitriel_wallet/application/utils/themes/colors.dart';
...
//                                     context, createKeyModel!.tmpSeed!, 0,
//                                     moreSize: 2.5),
//                               ),
//                               Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: SeedsCompoent().getColumn(
//                                     context, createKeyModel!.tmpSeed!, 1,
//                                     moreSize: 2.5),
//                               ),
//                               Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: SeedsCompoent().getColumn(
//                                     context, createKeyModel!.tmpSeed!, 2,
//                                     moreSize: 2.5),
//                               ),
//                             ],
//                           ),
...
//                   if (createKeyModel!.tmpThreeNum!.isNotEmpty)
//                     Padding(
...
//                                   context,
//                                   createKeyModel!.lsSeeds![int.parse(
//                                       createKeyModel!.tmpThreeNum![i])],
//                                   int.parse(createKeyModel!.tmpThreeNum![i]),
//                                   i,
//                                   onTap);
//                             }),
//                       ),
...
//                   Consumer<VerifySeedsProvider>(builder: (context, pro, wg) {
