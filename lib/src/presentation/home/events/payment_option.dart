          ...
          children: [
            Row(
              children: [
                ...
                const MyText(text: "Preferred Payment", fontWeight: FontWeight.bold, fontSize: 2.4, left: 10),
              ],
            ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: const [
                        MyText(text: "Bitriel Wallet", fontSize: 2.2, fontWeight: FontWeight.bold, ),
  ...
  Widget _otherPayment(){
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const MyText(text: "Stripe", fontSize: 2.4, fontWeight: FontWeight.bold),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const MyText(text: "Credit / Debit Card", fontSize: 2.2, fontWeight: FontWeight.bold),
