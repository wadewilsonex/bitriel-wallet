                      ...
                      ? Flexible(
                        child: Row(
                          children: [
                            ...
                            if (scModel!.change24h != "0")
                            double.parse(scModel!.change24h!).isNegative ? const Icon(UniconsLine.chart_down, color: Colors.red, size: 18) : const Icon(UniconsLine.arrow_growth, color: Colors.green, size: 18),
                          ],
                        ),
                      )
                      : Container(),
