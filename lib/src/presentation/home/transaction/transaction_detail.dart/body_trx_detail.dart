...
import 'package:wallet_apps/src/presentation/home/transaction/trx_explorer_webview.dart';
...
class BodyTransactionDetail extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          rowInfo("Txid","0xd1d77197f302.41ea761f1782d5870c5fdccc37246a963627e47849d982a1b347"),
  ...
  Widget rowInfo(String leadingText, String trailingText){
    return Padding(
      padding: EdgeInsets.symmetric(vertical: paddingSize - 10),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
