const polkadotApiContract = (function (exports, types, util, api, utilCrypto) {
  ...
  function v1ToV2Label(entry) {
    return util.objectSpread({}, entry, {
      label: Array.isArray(entry.name) ? entry.name[0] : entry.name
    });
  }
  ...
  function v1ToLatest(registry, v1) {
    return v1ToV2(registry, v1);
  }
  function v0ToLatest(registry, v0) {
  ...
  function getLatestMeta(registry, json) {
    const metadata = registry.createType('ContractMetadata', util.isObject(json.V2) ? {
      V2: json.V2
    } : util.isObject(json.V1) ? {
      V1: json.V1
    } : {
      V0: json
    });
  ...
  var _createArgs = _classPrivateFieldKey("createArgs");
  var _createEvent = _classPrivateFieldKey("createEvent");
  var _createMessage = _classPrivateFieldKey("createMessage");
  var _decodeArgs = _classPrivateFieldKey("decodeArgs");
  var _decodeMessage = _classPrivateFieldKey("decodeMessage");
  var _encodeArgs = _classPrivateFieldKey("encodeArgs");
  class Abi {
  ...
  ***************************************************************************** */
  ...
  var _query = _classPrivateFieldKey("query");
  var _tx$2 = _classPrivateFieldKey("tx");
  var _getGas = _classPrivateFieldKey("getGas");
  var _exec = _classPrivateFieldKey("exec");
  var _read = _classPrivateFieldKey("read");
    ...
    constructor(api, abi, address, decorateMethod) {
      ...
      Object.defineProperty(this, _exec, {
        ...
        value: (messageOrId, {
          ...
          return this.api.tx.contracts.call(this.address, value, _classPrivateFieldBase(this, _getGas)[_getGas](gasLimit), this.abi.findMessage(messageOrId).toU8a(params)).withResultTransform(result =>
  ...
  function extendContract(type, decorateMethod) {
    var _class, _temp;
    return _temp = _class = class extends Contract$2 {
      constructor(api, abi, address) {
        super(api, abi, address, decorateMethod);
      }
    }, _class.__ContractType = type, _temp;
  }
  ...
  var _tx$1 = _classPrivateFieldKey("tx");
  var _deploy = _classPrivateFieldKey("deploy");
  ...
  function extendBlueprint(type, decorateMethod) {
    var _class, _temp;
    return _temp = _class = class extends Blueprint$2 {
      constructor(api, abi, codeHash) {
        super(api, abi, codeHash, decorateMethod);
      }
    }, _class.__BlueprintType = type, _temp;
  }
  ...
  var _tx = _classPrivateFieldKey("tx");
  var _instantiate = _classPrivateFieldKey("instantiate");
  ...
  function extendCode(type, decorateMethod) {
    var _class, _temp;
    return _temp = _class = class extends Code$2 {
      constructor(api, abi, wasm) {
        super(api, abi, wasm, decorateMethod);
      }
    }, _class.__CodeType = type, _temp;
  }

  const Blueprint$1 = extendBlueprint('promise', api.toPromiseMethod);
  const Code$1 = extendCode('promise', api.toPromiseMethod);
  const Contract$1 = extendContract('promise', api.toPromiseMethod);

  const Blueprint = extendBlueprint('rxjs', api.toRxMethod);
  const Code = extendCode('rxjs', api.toRxMethod);
  const Contract = extendContract('rxjs', api.toRxMethod);
