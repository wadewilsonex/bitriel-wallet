...
import 'package:wallet_apps/src/presentation/home/events/checkout_ticket.dart';
...
class EventDetailPageState extends State<EventDetailPage> with TickerProviderStateMixin {
    ...
    return Row(
      children: <Widget>[
        ...
        Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            MyText(text: DateTimeUtils.getDayOfWeek(event.eventDate), fontSize: 2.6, fontWeight: FontWeight.bold,),
  ...
  Widget buildAboutEvent() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        const MyText(text: "Details", fontWeight: FontWeight.bold, fontSize: 2.6),
    ...
    return Row(
      children: <Widget>[
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            MyText(text: event.organizer, fontWeight: FontWeight.bold, fontSize: 2.6,),
            UIHelper.verticalSpace(4),
