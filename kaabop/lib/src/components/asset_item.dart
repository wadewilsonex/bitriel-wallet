...
class AssetItem extends StatelessWidget {
  ...
  AssetItem(
    ...
    {this.marketPrice, this.priceChange24h, this.size, this.lineChartData, this.prepareLineData, this.lineChartModel}
  );
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          belowBarData: BarAreaData(show: true, colors: [
            ColorTween(begin: hexaCodeToColor(AppColors.secondary), end: hexaCodeToColor("#00ff6b"))
              .lerp(0.2)
              .withOpacity(0.1),
            ColorTween(begin: hexaCodeToColor(AppColors.secondary), end: hexaCodeToColor("#00ff6b"))
              .lerp(0.2)
