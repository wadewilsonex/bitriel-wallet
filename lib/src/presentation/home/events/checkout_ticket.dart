...
import 'package:wallet_apps/src/presentation/home/events/payment_option.dart';
          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  const MyText(text: "ORDER SUMMARY", fontSize: 2.4, fontWeight: FontWeight.bold, textAlign: TextAlign.start,),
  ...
  Widget buildInfoOrder() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          MyText(text: widget.event.name, fontSize: 2.6, fontWeight: FontWeight.bold, textAlign: TextAlign.start,),
