                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Container(
                        // width: double.infinity,
                        margin: const EdgeInsets.only(left: 16.0, right: 16.0, bottom: 42),
                        height: 60,
                        child: Row(
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                child: Card(
                                  color: model.rateIndex == 1 ? hexaCodeToColor(AppColors.secondary) : hexaCodeToColor(AppColors.secondary).withOpacity(0),
                                  margin: EdgeInsets.zero,
                                  child: Container(
                                    alignment: Alignment.center,
                                    child: MyText(
                                      fontWeight: FontWeight.bold,
                                      color: model.rateIndex == 1 ? AppColors.whiteColorHexa : AppColors.greyCode,
                                      text: "10%"
                                    )
                                  ),
                                )
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                child: Card(
                                  color: model.rateIndex == 2 ? hexaCodeToColor(AppColors.secondary) : hexaCodeToColor(AppColors.secondary).withOpacity(0),
                                  margin: EdgeInsets.only(left: 10, right: 10),
                                  child: Container(
                                    alignment: Alignment.center,
                                    child: MyText(
                                      fontWeight: FontWeight.bold,
                                      color: model.rateIndex == 2 ? AppColors.whiteColorHexa : AppColors.blackColor,
                                      text: "20%"
                                    )
                                  ),
                                )
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                child: Card(
                                  color: model.rateIndex == 3 ? hexaCodeToColor(AppColors.secondary) : hexaCodeToColor(AppColors.secondary).withOpacity(0),
                                  margin: EdgeInsets.zero,
                                  child: Container(
                                    alignment: Alignment.center,
                                    child: MyText(
                                      color: model.rateIndex == 3 ? AppColors.whiteColorHexa : AppColors.blackColor,
                                      fontWeight: FontWeight.bold,
                                      text: "30%"
                                    )
                                  ),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: MyText(
                                  ...
                                  text: "Balance: ${contract.listContract[4].balance}"
                                ),
                              ),
