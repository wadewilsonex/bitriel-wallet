...
//   const VerifyPassphrase({Key? key})
//       : super(key: key);
...
//     widget.createKeyModel!
//         .missingSeeds[int.parse(widget.createKeyModel!.tmpThreeNum![0])] = "";
//     widget.createKeyModel!
//         .missingSeeds[int.parse(widget.createKeyModel!.tmpThreeNum![1])] = "";
//     widget.createKeyModel!
//         .missingSeeds[int.parse(widget.createKeyModel!.tmpThreeNum![2])] = "";

//     widget.createKeyModel!.tmpSeed =
//         widget.createKeyModel!.missingSeeds.join(" ");
//     setState(() {});
//   }
...
//         widget.createKeyModel!.missingSeeds[i] =
//             widget.createKeyModel!.lsSeeds![index];
//         break;
//       }
//     }
//     widget.createKeyModel!.tmpSeed =
...
//     _importAccountModel.animationController = AnimationController(
//         vsync: tickerProvider, duration: const Duration(seconds: 2));

//     _importAccountModel.loadingMgs = "LOADING...";

//     _importAccountModel.animation = Tween(begin: 0.0, end: 1.0)
//         .animate(_importAccountModel.animationController!);

//     _importAccountModel.animationController!.addListener(() {
//       if (_importAccountModel.animationController!.value >= 0.15 &&
//           _importAccountModel.animationController!.value <= 0.19) {
//         _importAccountModel.value =
//             _importAccountModel.animationController!.value;
//         _importAccountModel.animationController!.stop();
//       } else if (_importAccountModel.animationController!.value >= 0.40 &&
//           _importAccountModel.animationController!.value <= 0.49) {
//         _importAccountModel.value =
//             _importAccountModel.animationController!.value;
//         _importAccountModel.animationController!.stop();
//       } else if (_importAccountModel.animationController!.value >= 0.75 &&
//           _importAccountModel.animationController!.value <= 0.79) {
//         _importAccountModel.value =
//             _importAccountModel.animationController!.value;
//         _importAccountModel.animationController!.stop();
//       }
...
//         .encryptPrivateKey(_pk!, widget.createKeyModel!.lsSeeds!.join(" "));
...
//       if (value.isNotEmpty) {
//         widget.createKeyModel!.unverifyList = CreateKeyModel()
//             .fromJsonDb(List<Map<String, dynamic>>.from(jsonDecode(value)));
//       }
//     });
...
//     await _apiProvider!.getSdk.api.keyring.addAccount(_apiProvider!.getKeyring,
//         keyType: KeyType.mnemonic,
//         acc: jsn!,
//         password: widget.createKeyModel!.passCode);

//     _pk = await _apiProvider!
//         .getPrivateKey(widget.createKeyModel!.lsSeeds!.join(" "));
//     // ignore: use_build_context_synchronously
//     await Provider.of<ContractProvider>(context, listen: false)
//         .extractAddress(_pk!);

//     // ignore: use_build_context_synchronously
//     await _apiProvider!.queryBtcData(
//         context,
//         widget.createKeyModel!.lsSeeds!.join(" "),
//         widget.createKeyModel!.passCode);

//     widget.createKeyModel!.unverifyList.add(UnverifySeed(
//         address: jsn["address"],
//         status: _importAccountModel.status,
//         ethAddress:
//             Provider.of<ContractProvider>(context, listen: false).ethAdd,
//         btcAddress: conProvider!.listContract[_apiProvider!.btcIndex].address));

//     await StorageServices.writeSecureList(DbKey.privateList,
//         jsonEncode(widget.createKeyModel!.unverifyListToJson()));
...
//     try {
//       res = await api
//           .validateMnemonic(widget.createKeyModel!.missingSeeds.join(" "));
//       if (res == true) {
//         if (!mounted) return;
...
//         else {
//           if (Provider.of<VerifySeedsProvider>(context, listen: false)
//                   .isVerifying ==
//               true) {
//             await StorageServices.readSecure(DbKey.privateList)!
//                 .then((value) async {
//               /// From Multi Account
//               if (value.isNotEmpty) {
//                 widget.createKeyModel!.unverifyList = CreateKeyModel()
...
//               List<UnverifySeed> tmp = CreateKeyModel().fromJsonDb(
//                   List<Map<String, dynamic>>.from(jsonDecode(value)));

//               List<UnverifySeed> obj = tmp.where((element) {
//                 if (element.address == api.getKeyring.current.address)
//                   return true;
//                 return false;
//               }).toList();
...
//               widget.createKeyModel!.unverifyList[tmp.indexOf(obj[0])] =
//                   UnverifySeed(
//                       address: api.getKeyring.current.address,
//                       status: true,
//                       ethAddress: conProvider!.ethAdd,
//                       btcAddress: conProvider!
//                           .listContract[_apiProvider!.btcIndex].address);
...
//               Provider.of<VerifySeedsProvider>(context, listen: false)
//                   .getPrivateList[tmp.indexOf(obj[0])] = UnverifySeed(
//                       address: api.getKeyring.current.address,
//                       status: true,
//                       ethAddress: conProvider!.ethAdd,
//                       btcAddress: conProvider!
...
//               Navigator.popUntil(
//                   context, ModalRoute.withName(AppString.homeView));
//             });
//           }
